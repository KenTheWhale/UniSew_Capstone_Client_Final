            ...
            {showAppliedGarment && (<Box sx={{
                ...
                {selectedQuotation && (<Box sx={{
                    ...
                    <Typography variant="body2" sx={{
                        ...
                        {order.status === 'pending' && selectedQuotation.depositRate && (
                            <span style={{color: '#d97706', fontWeight: 600}}>
                                                This order is divided by two payment (Deposit Payment and Remaining Payment).{' '}A deposit of {selectedQuotation.depositRate || 50}% of quotation price plus service fee is required.
                                            </span>)}
                    </Typography>
                        ...
                        <Box sx={{display: 'flex', flexDirection: 'column', gap: 1}}>
                            ...
                            <Box sx={{
                                ...
                                <Typography variant="body2" sx={{
                                    ...
                                    Deposit amount ({(selectedQuotation.depositRate || 50)}% Quotation Price)
                                </Typography>
                                <Typography variant="body2" sx={{
                                    color: '#1e293b', fontWeight: 600, fontSize: '12px'
                                }}>
                            ...
                            {order.status === 'pending' && (<Box sx={{
                                ...
                                <Box>
                                    <Typography variant="body2" sx={{
                                        ...
                                        Deposit Required (First Payment)
                                    </Typography>
                                    <Typography variant="caption" sx={{
                                        color: '#d97706', fontSize: '10px'
                                    }}>
                                        Deposit = Quotation Price × Deposit Rate + Service Fee
                                    </Typography>
                                </Box>
                                <Typography variant="body2" sx={{
                            ...
                            <Box sx={{
                                ...
                                alignItems: 'center',
                                p: 1.5,
                                backgroundColor: order.status === 'pending' ? '#f3f4f6' : '#fef3c7',
                                borderRadius: 1.5,
                                border: order.status === 'pending' ? '1px solid #9ca3af' : '1px solid #f59e0b'
                            }}>
                                <Box>
                                    <Typography variant="body2" sx={{
                                        color: order.status === 'pending' ? '#374151' : '#92400e',
                                        fontWeight: 700,
                                        fontSize: '12px'
                                    }}>
                                        Remaining Amount (Second Payment - Before Delivery Stage)
                                    </Typography>
                                    <Typography variant="caption" sx={{
                                        color: order.status === 'pending' ? '#6b7280' : '#d97706', fontSize: '10px'
                                    }}>
                                        Remaining = Quotation Price - Deposit Amount + Shipping Fee
                                    </Typography>
                                </Box>
                                <Typography variant="body2" sx={{
                                    color: order.status === 'pending' ? '#6b7280' : '#d97706',
                                    fontWeight: 700,
                                    fontSize: '12px'
                                }}>
                                    {(selectedQuotation.price - ((selectedQuotation.depositRate || 50) * selectedQuotation.price / 100) + shippingFee).toLocaleString('vi-VN')} VND
                                </Typography>
                            </Box>
                            ...
                            >
                                ...
                                >
                                    <Box>
                                        ...
                                        >
                                            Total Amount = Quotation Price + Service Fee + Shipping Fee
                                        </Typography>
                                    </Box>
                                    <Typography
                                        variant="body2"
                                    ...
                                    >
                                        {(selectedQuotation.price + calculateServiceFee(selectedQuotation.price) + shippingFee).toLocaleString('vi-VN')} VND
                                    </Typography>
                                </Box>
                            </Box>
                            ...
                            {/*    }}>*/}
                            {/*        {order.status === 'pending' ? 'Deposit Payment' : 'Remaining Payment'}*/}
                            {/*    </Typography>*/}
                            {/*    <Typography variant="h6" sx={{*/}
                    ...
                    <Box sx={{
                        ...
                        >
                            Confirm {order.status === 'pending' ? 'Deposit Payment' : 'Remaining Payment'}
                        </Button>
                    </Box>
                </Box>)}
            </Box>)}
