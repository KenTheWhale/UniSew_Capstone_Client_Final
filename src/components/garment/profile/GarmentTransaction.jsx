...
export default function GarmentTransaction() {
    ...
    async function handleDownloadPdf() {
        ...
        doc.setFont("NotoSans", "normal");
        doc.setFontSize(14);
        doc.text("UniSew - Garment Transactions Report", margin, 40);
        ...
        doc.save(`garment_transactions_${new Date().toISOString().slice(0, 10)}.pdf`);
    }
    ...
    const filename = `garment_transactions_${new Date().toISOString().slice(0, 10)}.csv`;
