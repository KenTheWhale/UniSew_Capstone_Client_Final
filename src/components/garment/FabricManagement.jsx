...
import {deleteGarmentFabric, getGarmentFabric, updateGarmentFabric} from '../../services/SystemService';
import {FABRIC_PRICE_MAX, FABRIC_PRICE_MIN} from '../../configs/FixedVariables';
    ...
    return (
        <Box sx={{height: '100%', overflowY: 'auto'}}>
            ...
            >
                ...
                >
                    Manage fabric types and pricing for each size. You can add fabrics from the system and set custom
                                ...
                                <TableHead>
                                    <TableRow sx={{backgroundColor: "#f8fafc"}}>
                                        ...
                                        <TableCell align="center"
                                                   sx={{fontWeight: 700, color: "#1e293b"}}>Actions</TableCell>
                                    </TableRow>
                                </TableHead>
                                <TableBody>
                            ...
                            <Table stickyHeader>
                                <TableHead>
                                    <TableRow sx={{backgroundColor: "#f8fafc"}}>
                                        ...
                                        <TableCell sx={{fontWeight: 700, color: "#1e293b"}}>Height Range
                                            (cm)</TableCell>
                                        <TableCell sx={{fontWeight: 700, color: "#1e293b"}}>Weight Range
                                            (kg)</TableCell>
