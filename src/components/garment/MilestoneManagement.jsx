...
import {formatDateTime, formatDateTimeSecond, getShippingDaysFromTimestamp} from "../../utils/TimestampUtil.jsx";
                                                                ...
                                                                {updatingData ? (
                                                                    ...
                                                                    <Box sx={{
                                                                        ...
                                                                        {phase.completedDate && phase.completedDate !== "" && (
                                                                            <Chip
                                                                                label={`Completed: ${formatDateTimeSecond(phase.completedDate)}`}
                                                                                size="small"
                                                                                sx={{
                        ...
                        {selectedOrderDetail && (
                            <Box sx={{p: 4, display: 'flex', flexDirection: 'column', gap: 4}}>
                                ...
                                <Card sx={{
                                    ...
                                    <CardContent sx={{p: 3}}>
                                        <OrderDetailTable order={selectedOrderDetail} />
                                    </CardContent>
                                </Card>
                            </Box>
                        )}
