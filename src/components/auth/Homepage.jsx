...
export default function Homepage() {
    ...
    const stats = [
        {
            number: parseInt(statsNumber.numberSchoolAccount),
            label: "Schools Joined",
            icon: <SchoolIcon sx={{fontSize: 32, color: "#6C63FF"}}/>,
        },
        {
            number: parseInt(statsNumber.numberDesignerAccount),
            label: "Designers",
            icon: <DesignServicesIcon sx={{fontSize: 32, color: "#6C63FF"}}/>,
        },
        {
            number: parseInt(statsNumber.numberGarmentAccount),
            label: "Garment Factories",
            icon: <FactoryIcon sx={{fontSize: 32, color: "#6C63FF"}}/>,
        },
        {
            number: isSameYear ? today.getMonth() - 5 : today.getFullYear() - 2025,
            label: "Platform Age",
                ...
                <Container maxWidth="lg">
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <li>Collaborate with our expert designers through our simple online platform. Share your
                                    vision, upload ideas, and watch your concepts come to life without endless
                                    back-and-forth emails.
                                </li>
                                <li>Every project is uniquely crafted to reflect your brand identity and goals.</li>
                                <li>From concept sketches to final production, our designers ensure every element is
                                    flawless.
                                </li>
                            </Box>
                            <Button
