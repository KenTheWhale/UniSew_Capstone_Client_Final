        ...
        <Box sx={{backgroundColor: '#fafafa'}}>
            ...
            >
                <Container maxWidth="lg" sx={{position: "relative", zIndex: 1}}>
                    ...
                    >
                        Revolutionizing school uniform design and manufacturing with cutting-edge technology and
            ...
            <Box sx={{py: {xs: 8, md: 12}, backgroundColor: "#f8fafc"}}>
                <Container maxWidth="lg">
                    <Box sx={{textAlign: "center", mb: 8}}>
                        ...
                        >
                            We provide comprehensive solutions that address every aspect of school uniform needs, from
            ...
            <Box sx={{py: {xs: 8, md: 12}, backgroundColor: "white"}}>
                <Container maxWidth="lg">
                    <Box sx={{textAlign: "center", mb: 6}}>
                        ...
                        >
                            Our streamlined process ensures a seamless experience from initial design concept to final
                            product delivery.
                        </Typography>
                    </Box>
